...
export const Contact: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="w-full px-6 md:px-12 pt-32 pb-24 min-h-screen bg-[#faf9f6] flex flex-col justify-between text-[#111]">
      <div className="max-w-[1800px] w-full mx-auto">
         ...
         <div className="contact-anim grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 font-rubik">
             <div className="flex flex-col gap-8">
                 ...
                 <a href="mailto:zongnan.bao@gmail.com" className="text-xl md:text-3xl font-bold underline underline-offset-8 hover:text-black/60 transition-colors break-words">
             ...
             <div className="flex flex-col gap-6 items-start md:items-end">
                {socialLinks.map((social) => (
                    <a 
                        ...
                        target="_blank" 
                        rel="noreferrer" 
                        className="flex items-center gap-2 text-xl uppercase tracking-wide group hover:text-black/60 transition-colors"
                    >
      ...
      <div className="contact-anim text-center mt-24 opacity-50 text-sm uppercase tracking-widest font-rubik">
