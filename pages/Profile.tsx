    ...
    <div ref={containerRef} className="w-full px-6 md:px-12 pt-32 pb-24 min-h-screen bg-[#faf9f6]">
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="mb-24 profile-anim">
            <h1 className="text-[10vw] md:text-[12vw] leading-none font-bold tracking-normal uppercase text-white mix-blend-difference">Profile</h1>
        </div>
        ...
        <div className="grid grid-cols-12 gap-x-4 md:gap-x-8 gap-y-24 font-rubik">
            ...
            <div className="col-span-12 md:col-span-3 profile-anim">
                <span className="text-sm uppercase tracking-widest opacity-50 border-t border-black pt-4 inline-block w-full text-white mix-blend-difference">About</span>
            </div>
            <div className="col-span-12 md:col-span-9 flex flex-col gap-8 profile-anim">
                <p className="text-lg md:text-xl leading-relaxed text-white mix-blend-difference">
                    Hello, I'm <span className="font-bold">Zongnan Bao (鲍宗南)</span>.
                </p>
                <div className="text-base md:text-lg opacity-80 max-w-2xl text-white mix-blend-difference">
                    <p className="mb-4">
            ...
            {/* EXPERIENCE SECTION */}
            <div className="col-span-12 md:col-span-3 profile-anim">
                <span className="text-sm uppercase tracking-widest opacity-50 border-t border-black pt-4 inline-block w-full text-white mix-blend-difference">Experience</span>
            </div>
                ...
                {experiences.map((exp, i) => (
                    <div key={i} className="group border-b border-black/10 pb-12 last:border-0">
                        <div className="flex flex-col md:flex-row md:items-baseline justify-between mb-2">
                            <a href={exp.link} target="_blank" rel="noreferrer" className="text-xl md:text-2xl font-bold flex items-center gap-2 transition-all duration-300 hover:text-white/60 text-white mix-blend-difference">
                                {exp.company} <ArrowUpRight className="w-5 h-5 opacity-0 group-hover:opacity-100 transition-opacity" />
                            </a>
                            <span className="text-xs uppercase tracking-widest opacity-50 mt-1 md:mt-0 text-white mix-blend-difference">{exp.duration}</span>
                        </div>
                        <div className="text-lg font-medium mb-4 text-white mix-blend-difference">{exp.role}</div>
                        <p className="opacity-80 max-w-3xl leading-relaxed text-white mix-blend-difference text-base">{exp.description}</p>
                    </div>
                ))}
            </div>
            ...
            {/* EDUCATION SECTION */}
            <div className="col-span-12 md:col-span-3 profile-anim">
                <span className="text-sm uppercase tracking-widest opacity-50 border-t border-black pt-4 inline-block w-full text-white mix-blend-difference">Education</span>
            </div>
                ...
                {education.map((edu, i) => (
                    <div key={i} className="flex flex-col gap-4">
                        <div className="flex flex-col md:flex-row md:items-baseline justify-between">
                             <a href={edu.link} target="_blank" rel="noreferrer" className="text-xl md:text-2xl font-bold transition-all duration-300 hover:text-white/60 max-w-2xl text-white mix-blend-difference">
                                {edu.school}
                             </a>
                             <span className="text-xs uppercase tracking-widest opacity-50 mt-1 md:mt-0 shrink-0 text-white mix-blend-difference">{edu.period}</span>
                        </div>
                        <div className="text-lg font-medium text-white mix-blend-difference">{edu.degree}</div>
                        
                        <div className="mt-2">
                            <span className="text-xs uppercase tracking-widest opacity-50 block mb-2 text-white mix-blend-difference">Relevant Coursework</span>
                                ...
                                {edu.courses.map((c, idx) => (
                                    c.url ? (
                                        <a 
                                            ...
                                            target="_blank" 
                                            rel="noreferrer" 
                                            className="border border-black/10 px-3 py-1 rounded-full text-xs uppercase tracking-wide bg-white hover:bg-[#111] hover:text-[#faf9f6] transition-colors cursor-pointer text-white mix-blend-difference"
                                        >
                                            {c.name}
                                        </a>
                                    ) : (
                                        <span 
                                            key={idx} 
                                            className="border border-black/10 px-3 py-1 rounded-full text-xs uppercase tracking-wide bg-white hover:bg-[#111] hover:text-[#faf9f6] transition-colors cursor-default text-white mix-blend-difference"
                                        >
                                            {c.name}
                                        </span>
                                    )
            ...
            {/* PATENT SECTION */}
            <div className="col-span-12 md:col-span-3 profile-anim">
                <span className="text-sm uppercase tracking-widest opacity-50 border-t border-black pt-4 inline-block w-full text-white mix-blend-difference">Patents</span>
            </div>
            <div className="col-span-12 md:col-span-9 profile-anim">
                 ...
                 >
                    <h3 className="text-lg md:text-xl font-medium mb-2 text-white mix-blend-difference transition-colors duration-300 group-hover:text-white/60">
                        Estimating Metadata for Images Having Absent Metadata or Unusable Form of Metadata
                    </h3>
                    <p className="text-sm uppercase tracking-widest opacity-50 text-white mix-blend-difference">Dolby Laboratories, Inc.</p>
                 </a>
            </div>
